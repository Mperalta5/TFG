...
public class NodeMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Map<String, BlockingQueue<Runnable>> channelQueues = new HashMap<>();
                ...
                synchronized (mushrooms) {
                    ...
                    try {
                        ...
                        synchronized (snapshotLock) {
                            ...
                            if (
                                snapshotStarted[0]
                                && !markersReceived.contains(channel)
                            ) {
                                ...
                                System.out.println(
                                    "🧺 MENSAJE EN TRÁNSITO capturado en "
                                    + id
                                );
                            }
                        }
                ...
                synchronized (snapshotLock) {
                    ...
                    synchronized (snapshotLock) {
                        ...
                        if (!id.equals("mario")) {
                            ...
                            Map<String, List<String>> snapshotCopy = new HashMap<>();

                            for (var entry : channelStates.entrySet()) {
        ...
        server.createContext("/triggerSnapshot", exchange -> {
        ...
        while (true) {
            ...
            */
            ...
            String channel = id + "->" + target;

            channelQueues.get(channel).put(() -> {
    ...
    private static void startSnapshot(
    ...
    private static void printGlobalSnapshot(
       ...
       int total = 0;
        ...
        System.out.println(snapshotContent);

        snapshotWriter.println(snapshotContent);
    ...
    private static void sendSnapshotToVisualizer(String content) {
